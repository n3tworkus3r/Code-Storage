/*
	Define a union with bit fields to represent the given information.
	Describe a function to display the fields on the screen.
	Generate a random array of these structures.
	Sort the elements of the array using the standard std::sort function.
	Find repeating elements and display them on the screen.
	
	Combining unsigned short type to store the position of the hands of the clock.
	Bit fields: hour (0-11), minute(0-59), second(0-59).
